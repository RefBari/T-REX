...
# 640 km altitude, 7018.1 km semi-major axis, 350 deg RAAN, 85 deg inclination, 0 eccentricity, 0 argument of perigee
...
###############################################################################
    ...
    name = "TREX";
    mass = 150;  # Spacecraft mass, kg
    areaDrag = 2.5;  # Spacecraft drag area, m^2
    areaSolar = 2.5;  # Spacecraft solar area, m^2
...
###############################################################################
    ...
    sma = 7018.1  # semi-major axis, km 
    ecc = 0.0  # Eccentricity
    inc = 85.0  # Inclination, deg
    ra = 350.0 # Right ascension of the ascending node, deg
