...
# 620 km altitude, 6998.1 km semi-major axis, 230 deg RAAN, 85 deg inclination, 0 eccentricity, 0 argument of perigee
...
###############################################################################
    ...
    sma = 6998.1  # semi-major axis, km 
    ecc = 0.0  # Eccentricity
    inc = 85.0  # Inclination, deg
    ra = 230.0 # Right ascension of the ascending node, deg
